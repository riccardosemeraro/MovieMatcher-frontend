        ...
        <div className="popup">
            <div className="popup-inner">
...

                {
                    ...
                    <>
                    <div className="Contenitore-Impostazioni"> {/*perche non ha una classe definita nel css? PER GAIA */}
...

                {
                    ...
                    <div className="Contenitore-Partecipa">
                        <div className="Titolo">
                            <h1 className='impostazioni-partecipa'> Inserisci codice </h1>
                            <br/>
                        </div>
                        <div className='codice-pswIcon'>
                            <div className="CodicePartitaInput">
                                <input type="text" className="Inserire-codice-partita" placeholder="codice" />
                            </div>
